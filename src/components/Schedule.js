      ...
      <div className="">
        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
          ...
          <div className="flex flex-row-reverse md:contents">
            <div className="col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md bg-purple-700 border border-white">
        ...
        <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
          ...
          <div className="flex md:contents">
            ...
            <div className="col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md border bg-purple-700  border-white">
